  ...
  const getDetail = () => {
    system.setting().then((res: any) => {
      ...
      for (let index in configData) {
        if (configData[index].key === "meedu.upload.video.aliyun.region") {
        ...
        } else if (configData[index].key === "meedu.upload.video.aliyun.host") {
          form.setFieldsValue({
          ...
          form.setFieldsValue({
            "meedu.upload.video.aliyun.access_key_id": configData[index].value,
          });
        } else if (
    ...
    <div className="meedu-main-body">
      ...
      <div className="float-left">
        ...
        >
          ...
          <Form.Item label="腾讯云视频SecretKey" name="tencent.vod.secret_key">
            <Input style={{ width: 300 }} allowClear />
          </Form.Item>
          <Form.Item
            label="腾讯云播放key"
