    ...
    system.setting().then((res: any) => {
      ...
      for (let index in configData) {
        if (configData[index].key === "meedu.addons.zhibo.default_service") {
          ...
          configData[index].key === "meedu.addons.zhibo.default_attach_service"
        ) {
          form.setFieldsValue({
          ...
          form.setFieldsValue({
            "meedu.addons.zhibo.aliyun.access_secret": configData[index].value,
          });
        } else if (
          ...
          form.setFieldsValue({
            "meedu.addons.zhibo.aliyun.record.region": configData[index].value,
          });
        } else if (
          ...
          form.setFieldsValue({
            "meedu.addons.zhibo.go-meedu.internal_url": configData[index].value,
          });
        } else if (
    ...
    <div className="meedu-main-body">
      ...
      <div className="float-left">
        ...
        >
          ...
          <Form.Item label="聊天服务Key" name="meedu.addons.zhibo.go-meedu.key">
            <Input style={{ width: 300 }} allowClear />
          </Form.Item>
        </Form>
      </div>
