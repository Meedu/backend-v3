    ...
    system.setting().then((res: any) => {
      ...
      for (let index in configData) {
        if (configData[index].key === "meedu.system.player_thumb") {
          ...
          form.setFieldsValue({
            "meedu.system.player.bullet_secret.color": configData[index].value,
          });
        } else if (
          configData[index].key === "meedu.system.player.bullet_secret.opacity"
        ) {
          let value = 0;
    ...
    <div className="meedu-main-body">
      ...
      <div className="float-left">
        ...
        >
          ...
          <Form.Item label="内容" name="meedu.system.player.bullet_secret.text">
            <Space align="baseline" style={{ height: 32 }}>
