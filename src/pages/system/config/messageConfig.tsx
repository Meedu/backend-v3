  ...
  const getDetail = () => {
    system.setting().then((res: any) => {
      ...
      for (let index in configData) {
        if (configData[index].key === "meedu.system.sms") {
        ...
        } else if (configData[index].key === "sms.gateways.aliyun.sign_name") {
          form.setFieldsValue({
          ...
          form.setFieldsValue({
            "sms.gateways.aliyun.template.mobile_bind": configData[index].value,
          });
        } else if (
        ...
        } else if (configData[index].key === "sms.gateways.tencent.secret_id") {
          form.setFieldsValue({
        ...
        } else if (configData[index].key === "sms.gateways.tencent.sign_name") {
          form.setFieldsValue({
          ...
          configData[index].key === "sms.gateways.tencent.template.mobile_bind"
        ) {
          form.setFieldsValue({
          ...
          configData[index].key === "sms.gateways.yunpian.template.mobile_bind"
        ) {
          form.setFieldsValue({
    ...
    <div className="meedu-main-body">
      ...
      <div className="float-left">
        ...
        >
          ...
          {sms === "yunpian" && (
            <>
              <Form.Item label="云片ApiKey" name="sms.gateways.yunpian.api_key">
                <Input style={{ width: 300 }} allowClear />
              </Form.Item>
              <Form.Item
                label="云片密码重置模板"
