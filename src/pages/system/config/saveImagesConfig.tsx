    ...
    system.setting().then((res: any) => {
      ...
      for (let index in configData) {
        if (configData[index].key === "meedu.upload.image.disk") {
          ...
          form.setFieldsValue({
            "filesystems.disks.qiniu.domains.default": configData[index].value,
          });
        } else if (
        ...
        } else if (configData[index].key === "filesystems.disks.qiniu.bucket") {
          form.setFieldsValue({
        ...
        } else if (configData[index].key === "filesystems.disks.oss.endpoint") {
          form.setFieldsValue({
          ...
          form.setFieldsValue({
            "filesystems.disks.cos.credentials.appId": configData[index].value,
          });
        } else if (
          configData[index].key === "filesystems.disks.cos.credentials.secretId"
        ) {
          form.setFieldsValue({
